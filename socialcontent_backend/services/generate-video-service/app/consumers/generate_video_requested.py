...
from app.services.generate_video import process_generate_video_render_run, process_generate_video_script_run
...
def run_generate_video_requested_consumer() -> None:
    ...
    kafka_consumer = consumer(
        [GENERATE_VIDEO_SCRIPT_REQUESTED, GENERATE_VIDEO_RENDER_REQUESTED],
