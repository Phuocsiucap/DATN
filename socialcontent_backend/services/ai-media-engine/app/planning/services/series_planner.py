...
class SeriesPlannerService:
    ...
    ) -> tuple[list[dict[str, Any]], str, str, int, int, int]:
        """
        Generates structured parts list for a series.
        Returns (parts_list, provider_name, model_name, latency_ms, input_tokens, output_tokens)
        """
...
"""
        ...
        if settings.openai_api_key:
            try:
                ...
                return validated_parts, result.provider, result.model, result.latency_ms, result.input_tokens, result.output_tokens
