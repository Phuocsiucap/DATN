...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_crawl_job_schedules_enabled"), "crawl_job_schedules", ["enabled"], unique=False)
    op.create_index(op.f("ix_crawl_job_schedules_job_id"), "crawl_job_schedules", ["job_id"], unique=True)
    op.create_index(op.f("ix_crawl_job_schedules_next_run_at"), "crawl_job_schedules", ["next_run_at"], unique=False)
