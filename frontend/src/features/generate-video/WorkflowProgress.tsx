...
const stageLabels: Record<string, string> = {
  ...
  GENERATING_DRAFT: 'Đang tự động viết kịch bản & draft',
  ...
  QUEUED_EDIT: 'Đang chờ chỉnh sửa tự động',
  EDITING_DRAFT: 'Đang tự động chỉnh sửa draft',
  QUEUED_REVIEW: 'Đang chờ kiểm duyệt tự động',
  REVIEWING_DRAFT: 'Đang tự động kiểm duyệt kịch bản',
  REVIEW_COMPLETE: 'Kiểm duyệt tự động hoàn tất',
...
function taskTypeLabel(value: string) {
  const labels: Record<string, string> = {
    ...
    GENERATE_VIDEO_EDIT: 'Chỉnh sửa tự động',
    GENERATE_VIDEO_REVIEW: 'Tự động kiểm duyệt',
